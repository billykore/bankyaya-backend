  ...
  <div style="margin:50px auto;width:70%;padding:20px 0">
    <div style="border-bottom:1px solid #eee">
      <a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">
          PT. Bank Sedekah Hati (Persero), Tbk.
      </a>
    </div>
    ...
    <p>Destination Bank: PT. Bank Sedekah Hati (Persero), Tbk.</p>
    <p>Amount: 50000</p>
    <p>Fee: 0</p>
    <p>Transaction ID: trf-00001</p>
    <p>Note: test</p>
    <p style="font-size:0.9em;">Regards,<br/>PT. Bank Sedekah Hati (Persero), Tbk.</p>
    <hr style="border:none;border-top:1px solid #eee"/>
    <div style="float:right;padding:8px 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300">
      <p>PT. Bank Sedekah Hati (Persero), Tbk.</p>
      <p>Jakarta</p>
      <p>Indonesia</p>
    </div>
  </div>
