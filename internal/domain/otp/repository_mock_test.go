...
func (_m *MockRepository) Get(ctx context.Context, id int64) (*OTP, error) {
	ret := _m.Called(ctx, id)

	var r0 *OTP
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int64) (*OTP, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int64) *OTP); ok {
		r0 = rf(ctx, id)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*OTP)
...
func (_c *MockRepository_Get_Call) RunAndReturn(run func(context.Context, int64) (*OTP, error)) *MockRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}
