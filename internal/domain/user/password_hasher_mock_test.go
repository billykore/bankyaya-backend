...
func (_m *MockPasswordHasher) Compare(password string, hashed string) bool {
...
//   - password string
//   - hashed string
func (_e *MockPasswordHasher_Expecter) Compare(password interface{}, hashed interface{}) *MockPasswordHasher_Compare_Call {
	return &MockPasswordHasher_Compare_Call{Call: _e.mock.On("Compare", password, hashed)}
}

func (_c *MockPasswordHasher_Compare_Call) Run(run func(password string, hashed string)) *MockPasswordHasher_Compare_Call {
